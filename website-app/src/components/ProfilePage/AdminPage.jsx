          ...
          <Header></Header>
            <div className={styles.mainInfo}>
                ...
                <div className={styles.layer2}>
                    ...
                    <a className={styles.addFilm} href="">Thêm phim</a>
                </div>
            </div>
            <div className={styles.tag_container}>
                <a className={styles.tag} href=""> &#x2023; Kiểm duyệt </a>
                <a className={styles.more} href=""> Xem thêm... </a>
            </div>
            ...
            <div className={styles.tag_container}>
                <a className={styles.tag} href=""> &#x2023; Tố cáo</a>
                <a className={styles.more} href=""> Xem thêm... </a>
            </div>
            <div className={styles.content}>
                <div className={styles.item}>
